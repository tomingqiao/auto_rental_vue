        ...
        <el-main>
            <el-form :model="autoInfoModel" size="small" :inline="true">
                ...
                <el-form-item label="操作:">
                    <el-button type="primary" :icon="getPermissionIcon('auto:info:select')" size="small"
                        v-if="hasPermission('auto:info:select')" @click="onSubmit">查询</el-button>
                    <el-button type="warning" :icon="getPermissionIcon('auto:info:reset')" size="small"
                        @click="resetForm" v-if="hasPermission('auto:info:reset')">重置</el-button>
                    <el-button type="success" :icon="getPermissionIcon('auto:info:add')" size="small"
            ...
            <el-table :data="autoInfoList" stripe border style="width: 100%;margin-bottom: 20px"
                ...
                <el-table-column prop="autoNum" label="车牌号码" width="150"></el-table-column>
                <el-table-column prop="makerName" label="厂商名称" width="150"></el-table-column>
                ...
                <el-table-column label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        <el-button type="primary" :icon="getPermissionIcon('auto:info:edit')" size="small"
                            v-if="hasPermission('auto:info:edit')" @click="handleEdit(scope.row)">修改</el-button>
                        <el-button type="danger" :icon="getPermissionIcon('auto:info:delete')" size="small"
                            v-if="hasPermission('auto:info:delete')" @click="handleDelete(scope.row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
